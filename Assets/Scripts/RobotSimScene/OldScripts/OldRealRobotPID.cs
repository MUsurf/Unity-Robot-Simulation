...
// {
//     public Rigidbody rb;
//     private RealRobotPIDHandler LeHandler = new RealRobotPIDHandler();
...
//         LeHandler.xRealRobotPIDController.kP = andrewList[0];
//         LeHandler.xRealRobotPIDController.kI = andrewList[1];
//         LeHandler.xRealRobotPIDController.kD = andrewList[2];
//         LeHandler.yRealRobotPIDController.kP = andrewList[3];
//         LeHandler.yRealRobotPIDController.kI = andrewList[4];
//         LeHandler.yRealRobotPIDController.kD = andrewList[5];
//         LeHandler.zRealRobotPIDController.kP = andrewList[6];
//         LeHandler.zRealRobotPIDController.kI = andrewList[7];
//         LeHandler.zRealRobotPIDController.kD = andrewList[8];
//         LeHandler.rollRealRobotPIDController.kP = andrewList[9];
//         LeHandler.rollRealRobotPIDController.kI = andrewList[10];
//         LeHandler.rollRealRobotPIDController.kD = andrewList[11];
//         LeHandler.pitchRealRobotPIDController.kP = andrewList[12];
//         LeHandler.pitchRealRobotPIDController.kI = andrewList[13];
//         LeHandler.pitchRealRobotPIDController.kD = andrewList[14];
//         LeHandler.yawRealRobotPIDController.kP = andrewList[15];
//         LeHandler.yawRealRobotPIDController.kI = andrewList[16];
//         LeHandler.yawRealRobotPIDController.kD = andrewList[17];
...
//         forces = getVectors(RealRobotPowerControl.calculatePowers(powerArray[0], powerArray[1], powerArray[2], powerArray[3], powerArray[4], -powerArray[5]));
...
//     public RealRobotPIDController(float kP, float kI, float kD){
//         this.kP = kP;
//         this.kI = kI;
//         this.kD = kD;
//         last_time = 0;
...
// public class RealRobotPIDHandler{
//     public RealRobotPIDController xRealRobotPIDController;
//     public RealRobotPIDController yRealRobotPIDController;
//     public RealRobotPIDController zRealRobotPIDController;
//     public RealRobotPIDController rollRealRobotPIDController;
//     public RealRobotPIDController pitchRealRobotPIDController;
//     public RealRobotPIDController yawRealRobotPIDController;

//     public RealRobotPIDHandler(){
//         //PID parameters are set inside here instead of constant variables
//         xRealRobotPIDController = new RealRobotPIDController(
//             0.5f,
//             0,
//             0.1f
//         );
//         yRealRobotPIDController = new RealRobotPIDController(
//             0.5f,
//             0,
//             0.1f
//         );
//         zRealRobotPIDController = new RealRobotPIDController(
//             0.5f,
//             0,
//             0.1f
//         );
//         rollRealRobotPIDController = new RealRobotPIDController(
//             0.05f,
//             0,
//             0.1f
//         );
//         pitchRealRobotPIDController = new RealRobotPIDController(
//             0.05f,
//             0,
//             0.1f
//         );
//         yawRealRobotPIDController = new RealRobotPIDController(
//             0.05f,
//             0,
//             0.1f
//         );
...
//     ){
//         return new float[6]{
//             (x_setpoint == null || x_measurement == null) ? 0 : xRealRobotPIDController.calculate((float)x_setpoint, (float)x_measurement),
//             (y_setpoint == null || y_measurement == null) ? 0 : yRealRobotPIDController.calculate((float)y_setpoint, (float)y_measurement),
//             (z_setpoint == null || z_measurement == null) ? 0 : zRealRobotPIDController.calculate((float)z_setpoint, (float)z_measurement),
//             (roll_setpoint == null || roll_measurement == null) ? 0 : rollRealRobotPIDController.calculate((float)roll_setpoint, (float)roll_measurement),
//             (pitch_setpoint == null || pitch_measurement == null) ? 0 : pitchRealRobotPIDController.calculate((float)pitch_setpoint, (float)pitch_measurement),
//             (yaw_setpoint == null || yaw_measurement == null) ? 0 : yawRealRobotPIDController.calculate((float)yaw_setpoint, (float)yaw_measurement)
//         };
//     }
// }

// public static class RealRobotPowerControl{
